...
import { IPiece, KEY, COLS, ROWS, BLOCK_SIZE, LEVEL, LINES_PER_LEVEL, COLORS, POINTS, Piece } from '../../../interfacees/tetris';
import { TetrisService } from '../../../servicees/tetris.service';
...
export class TetrisComponent implements OnInit {
  ...
  current_user
  tetris_game = new Score({game_name:'טטריס',user_score:0})

constructor(private service: TetrisService,private signSvc:SignService) {}
